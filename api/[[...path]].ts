...
import * as route0 from "../src/server/vercel-api/operations/reconciliation";
import * as route1 from "../src/server/vercel-api/cron/monthly-fuel-sync";
import * as route2 from "../src/server/vercel-api/operations/anomalies";
import * as route3 from "../src/server/vercel-api/operations/suppliers";
import * as route4 from "../src/server/vercel-api/game-catalog-proxy";
import * as route5 from "../src/server/vercel-api/operations/payment";
import * as route6 from "../src/server/vercel-api/operations/station";
import * as route7 from "../src/server/vercel-api/operations/credit";
import * as route8 from "../src/server/vercel-api/operations/drawer";
import * as route9 from "../src/server/vercel-api/operations/period";
import * as route10 from "../src/server/vercel-api/reports/canonical";
import * as route11 from "../src/server/vercel-api/operations/pumps";
import * as route12 from "../src/server/vercel-api/operations/roles";
import * as route13 from "../src/server/vercel-api/operations/shift";
import * as route14 from "../src/server/vercel-api/cron/etims-sync";
import * as route15 from "../src/server/vercel-api/mpesa/stkstatus";
import * as route16 from "../src/server/vercel-api/operations/cash";
import * as route17 from "../src/server/vercel-api/operations/rbac";
import * as route18 from "../src/server/vercel-api/operations/sale";
import * as route19 from "../src/server/vercel-api/operations/sync";
import * as route20 from "../src/server/vercel-api/operations/tank";
import * as route21 from "../src/server/vercel-api/mpesa/callback";
import * as route22 from "../src/server/vercel-api/etims/invoice";
import * as route23 from "../src/server/vercel-api/founder-admin";
import * as route24 from "../src/server/vercel-api/founder-stats";
import * as route25 from "../src/server/vercel-api/live-channels";
import * as route26 from "../src/server/vercel-api/mpesa/stkpush";
import * as route27 from "../src/server/vercel-api/system/health";
import * as route28 from "../src/server/vercel-api/integrations";
import * as route29 from "../src/server/vercel-api/payslip-link";
import * as route30 from "../src/server/vercel-api/subscription";
import * as route31 from "../src/server/vercel-api/etims/retry";
import * as route32 from "../src/server/vercel-api/fuel-prices";
import * as route33 from "../src/server/vercel-api/movie-embed";
import * as route34 from "../src/server/vercel-api/fuel-local";
import * as route35 from "../src/server/vercel-api/sync/apply";
import * as route36 from "../src/server/vercel-api/hls-proxy";
import * as route37 from "../src/server/vercel-api/movies";
