...
type RouteDef = {
  ...
  name: string;
  /** Static query params the handler should always see (path aliases). */
  query?: Record<string, string>;
};
const routes: RouteDef[] = [
  {
    pattern: new RegExp("^/api/operations/reconciliation/?$"),
    params: [],
    module: route0,
    name: "operations/reconciliation.ts",
  },
  {
    pattern: new RegExp("^/api/cron/monthly-fuel-sync/?$"),
    params: [],
    module: route1,
    name: "cron/monthly-fuel-sync.ts",
  },
  {
    pattern: new RegExp("^/api/operations/anomalies/?$"),
    params: [],
    module: route2,
    name: "operations/anomalies.ts",
  },
  {
    pattern: new RegExp("^/api/operations/suppliers/?$"),
    params: [],
    module: route3,
    name: "operations/suppliers.ts",
  },
  {
    pattern: new RegExp("^/api/game-catalog-proxy/?$"),
    params: [],
    module: route4,
    name: "game-catalog-proxy.ts",
  },
  {
    pattern: new RegExp("^/api/operations/payment/?$"),
    params: [],
    module: route5,
    name: "operations/payment.ts",
  },
  {
    pattern: new RegExp("^/api/operations/station/?$"),
    params: [],
    module: route6,
    name: "operations/station.ts",
  },
  {
    pattern: new RegExp("^/api/operations/credit/?$"),
    params: [],
    module: route7,
    name: "operations/credit.ts",
  },
  {
    pattern: new RegExp("^/api/operations/drawer/?$"),
    params: [],
    module: route8,
    name: "operations/drawer.ts",
  },
  {
    pattern: new RegExp("^/api/operations/period/?$"),
    params: [],
    module: route9,
    name: "operations/period.ts",
  },
  {
    pattern: new RegExp("^/api/reports/canonical/?$"),
    params: [],
    module: route10,
    name: "reports/canonical.ts",
  },
  {
    pattern: new RegExp("^/api/operations/pumps/?$"),
    params: [],
    module: route11,
    name: "operations/pumps.ts",
  },
  {
    pattern: new RegExp("^/api/operations/roles/?$"),
    params: [],
    module: route12,
    name: "operations/roles.ts",
  },
  {
    pattern: new RegExp("^/api/operations/shift/?$"),
    params: [],
    module: route13,
    name: "operations/shift.ts",
  },
  {
    pattern: new RegExp("^/api/cron/etims-sync/?$"),
    params: [],
    module: route14,
    name: "cron/etims-sync.ts",
  },
  {
    pattern: new RegExp("^/api/mpesa/stkstatus/?$"),
    params: [],
    module: route15,
    name: "mpesa/stkstatus.ts",
  },
  {
    pattern: new RegExp("^/api/operations/cash/?$"),
    params: [],
    module: route16,
    name: "operations/cash.ts",
  },
  {
    pattern: new RegExp("^/api/operations/rbac/?$"),
    params: [],
    module: route17,
    name: "operations/rbac.ts",
  },
  {
    pattern: new RegExp("^/api/operations/sale/?$"),
    params: [],
    module: route18,
    name: "operations/sale.ts",
  },
  {
    pattern: new RegExp("^/api/operations/sync/?$"),
    params: [],
    module: route19,
    name: "operations/sync.ts",
  },
  {
    pattern: new RegExp("^/api/operations/tank/?$"),
    params: [],
    module: route20,
    name: "operations/tank.ts",
  },
  {
    pattern: new RegExp("^/api/mpesa/callback/?$"),
    params: [],
    module: route21,
    name: "mpesa/callback.ts",
  },
  {
    pattern: new RegExp("^/api/etims/invoice/?$"),
    params: [],
    module: route22,
    name: "etims/invoice.ts",
  },
  {
    pattern: new RegExp("^/api/founder-admin/?$"),
    params: [],
    module: route23,
    name: "founder-admin.ts",
  },
  {
    pattern: new RegExp("^/api/founder-stats/?$"),
    params: [],
    module: route24,
    name: "founder-stats.ts",
  },
  {
    pattern: new RegExp("^/api/live-channels/?$"),
    params: [],
    module: route25,
    name: "live-channels.ts",
  },
  // Alias: the client's iptv-org fetch targets /api/iptv-channels (the
  // Cloudflare Pages Function keeps that path). Route it to the same handler
  // with the provider selector so both hosts answer identically.
  {
    pattern: new RegExp("^/api/iptv-channels/?$"),
    params: [],
    module: route25,
    name: "live-channels.ts",
    query: { source: "iptv" },
  ...
  {
    pattern: new RegExp("^/api/mpesa/stkpush/?$"),
    params: [],
    module: route26,
    name: "mpesa/stkpush.ts",
  },
  {
    pattern: new RegExp("^/api/system/health/?$"),
    params: [],
    module: route27,
    name: "system/health.ts",
  },
  {
    pattern: new RegExp("^/api/integrations/?$"),
    params: [],
    module: route28,
    name: "integrations.ts",
  },
  {
    pattern: new RegExp("^/api/payslip-link/?$"),
    params: [],
    module: route29,
    name: "payslip-link.ts",
  },
  {
  ...
  {
    pattern: new RegExp("^/api/etims/retry/?$"),
    params: [],
    module: route31,
    name: "etims/retry.ts",
  },
  {
    pattern: new RegExp("^/api/fuel-prices/?$"),
    params: [],
    module: route32,
    name: "fuel-prices.ts",
  },
  {
    pattern: new RegExp("^/api/movie-embed/?$"),
    params: [],
    module: route33,
    name: "movie-embed.ts",
  },
  {
    pattern: new RegExp("^/api/fuel-local/?$"),
    params: [],
    module: route34,
    name: "fuel-local.ts",
  },
  {
    pattern: new RegExp("^/api/sync/apply/?$"),
    params: [],
    module: route35,
    name: "sync/apply.ts",
  },
  {
    pattern: new RegExp("^/api/hls-proxy/?$"),
    params: [],
    module: route36,
    name: "hls-proxy.ts",
  },
  {
    pattern: new RegExp("^/api/movies/?$"),
    params: [],
    module: route37,
    name: "movies.ts",
  },
  {
    pattern: new RegExp("^/api/quenq-embed(?:/(.*))?/?$"),
    params: [{ name: "path", kind: "optionalCatchAll" }],
    module: route38,
    name: "quenq-embed/[[...path]].ts",
  },
  {
    pattern: new RegExp("^/api/game-embed(?:/(.*))?/?$"),
    params: [{ name: "path", kind: "optionalCatchAll" }],
    module: route39,
    name: "game-embed/[[...path]].ts",
  },
  {
    pattern: new RegExp("^/api/pump-mapping/([^/]+)/?$"),
    params: [{ name: "action", kind: "single" }],
    module: route40,
    name: "pump-mapping/[action].ts",
  },
  {
    pattern: new RegExp("^/api/domain/verify/?$"),
    params: [],
    module: route41,
    name: "domain/verify.ts",
  },
  {
    pattern: new RegExp("^/api/payhero/stkpush/?$"),
    params: [],
    module: route42,
    name: "payhero/stkpush.ts",
  },
  {
    pattern: new RegExp("^/api/customer-portal/?$"),
    params: [],
    module: route43,
...
function setQuery(
  ...
  if (fixed) Object.assign(query, fixed);
...
async function invokeWeb(
  ...
  if (out instanceof Response) return sendResponse(res, out);
  res.statusCode = 200;
  res.end(out == null ? "" : String(out));
}
...
export default async function handler(
  ...
  match.params.forEach((p, i) => {
    ...
    params[p.name] =
      p.kind === "catchAll" || p.kind === "optionalCatchAll"
        ? raw.split("/").filter(Boolean).map(decodeURIComponent).join("/")
        : decodeURIComponent(raw);
  });
  setQuery(req, url, params, (match as any).query);
  try {
    const mod = match.module;
    const web =
      ["GET", "POST", "PUT", "PATCH", "DELETE", "OPTIONS", "HEAD"].some(
        (m) => typeof mod[m] === "function",
      ) || typeof mod.default?.fetch === "function";
    if (web) await invokeWeb(mod, req, res);
    else await invokeNode(mod, req, res);
  } catch (error) {
    if (res.headersSent) {
      res.end();
      return;
