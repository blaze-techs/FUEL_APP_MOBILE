...
export async function POST(request: Request): Promise<Response> {
  try {
    ...
    if (!["founder", "admin"].includes(String(ctx.globalRole)))
      throw Object.assign(new Error("Founder/admin only"), { status: 403 });
