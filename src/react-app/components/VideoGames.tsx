  ...
  return (
    ...
    >
      ...
      >
        {/* Player header */}
        <div
          data-fuelpro-fullscreen-chrome
          className="fuelpro-fullscreen-chrome absolute top-0 left-0 right-0 z-20 flex items-center gap-2 px-3 py-2 bg-gradient-to-b from-black/70 to-transparent"
        >
        ...
        {!external && (
          <div
            data-fuelpro-fullscreen-chrome
            className="fuelpro-fullscreen-chrome absolute bottom-0 left-0 right-0 z-10 px-3 py-1.5 bg-gradient-to-t from-black/70 to-transparent flex items-center gap-1.5"
          >
