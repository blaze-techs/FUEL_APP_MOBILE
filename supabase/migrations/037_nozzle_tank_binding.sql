-- Migration 037: bind dispensing nozzles to physical tanks so sales move the right tank.
...
VALUES('037_nozzle_tank_binding','passed',jsonb_build_object('applied_at',NOW()));
